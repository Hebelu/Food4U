...
export default function UserLogin() {
    const [loginDetails, setLoginDetails] = useState({
            ...
            const handleSubmit = (e) => {
                ...
                const foundUser = dbUser.find((user) =>user.email === loginDetails.email && user.password === loginDetails.password);
                if (foundUser) {
  ...
  return (
    ...
    <div className='bg-success'><marquee><h1>Welcome to Resturant Food4U</h1></marquee></div><hr></hr><br/><br/><br/><br/>
            ...
            <form onSubmit={handleSubmit} className='container'>
                <div className='card bg-info'>
                    <div className='card-header text-danger text-center'>
                        <h1>User Login <span class="material-symbols-outlined fw-bolder">login </span></h1>
                  {error && <p className='errmsg'>Wrong email or password</p>} 

                    </div>
                    <div className='card-body'>
                        <div className='form-group'>
                            <label>Mail Id <span class="material-symbols-outlined">mail</span><span className='errmsg'>*</span></label>
                    ...
                    <div className='card-footer'>
                        ...
                        Account Not Existed..!<Link className='btn btn-success' to={'/userregister'}>New User</Link>
                    </div>
                </div>
            </form>
        </div>
