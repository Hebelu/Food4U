...
export default function Items({ id, image, title, date, price }) {
  ...
  return (
    <div className='bg-dark row justify-content-center col-lg-4 col-md-6 col-sm-12 mb-4'>
      <div className='mx-2'>
        <div className='card h-100 shadow bg-warning py-2 ucard'>
          <img src={image} className='card-img-top img-fluid mx-4 py-2 rounded-circle'
          ...
          <div className='card-body'>
            ...
            <button className='btn btn-success  mx-4 fw-bold' onClick={() =>addToCart({ id, image, title, date, price, quantity: 1 })}>Add 2 cart <span class="material-symbols-outlined">add_shopping_cart</span></button>
