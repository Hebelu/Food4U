                            ...
                            <div className='row'>
                                ...
                                <div className='col-lg-6'>
                                    <div className='form-group'>
                                        ...
                                        <input className='form-control' placeholder='Enter your Password' name='password' value={values.password} onChange={e =>setValues({...values, password: e.target.value})}></input>
                                    </div>
                                </div>
                                <div className='col-lg-6'>
                                    <div className='form-group'>
                                        <label>Confirm-Password<span className='errmsg'>*</span></label>
                                        <input className='form-control' placeholder='Confirm your Password' name='confirmPassword' value={values.confirmPassword} onChange={e =>setValues({...values, confirmPassword: e.target.value})}></input>
                                    </div>
                                </div>
